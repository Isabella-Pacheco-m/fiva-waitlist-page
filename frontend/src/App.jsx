    ...
    <main className="min-h-screen w-full bg-white relative flex flex-col font-sans selection:bg-yellow-50 italic-none">
            ...
            <div className="lg:col-span-6 flex flex-col justify-center gap-6 lg:gap-7 order-1 z-20 py-6 lg:py-0">
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="text-xs text-gray-400 hover:text-[#F5C423] transition-colors underline"
                >
      ...
      {showPrivacy && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="max-w-2xl w-full bg-white rounded-3xl p-8 sm:p-12 border border-gray-100 shadow-xl relative">
            <button 
            ...
            <h2 className="text-3xl sm:text-4xl font-black text-gray-900 mb-8">
              Políticas de <span className="text-[#F5C423]">Privacidad</span>
            </h2>
            
            <div className="space-y-6 text-gray-500 font-medium">
              <p className="text-xl font-bold text-gray-900">
                Privacidad exclusiva para <span className="text-[#F5C423]">FIVA</span>.
              </p>
              <p>
                Sus datos corporativos y de contacto se usarán únicamente para análisis de público y comunicaciones oficiales de FIVA. No los compartimos con terceros.
              </p>
            </div>
          </div>
        </div>
